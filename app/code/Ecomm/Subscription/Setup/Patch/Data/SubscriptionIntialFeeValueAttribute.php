...
class SubscriptionIntialFeeValueAttribute implements DataPatchInterface, PatchRevertableInterface
{
    private const ATTRIBUTE_CODE = 'subscription_intialfee_value';
